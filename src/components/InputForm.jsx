    ...
    return (
      <div>
        <div className='container'>
          ...
          <select id='select' className='custom-select custom-select-lg' name='country' onChange={this.handleChange}>
          ...
          <button onClick={this.handleSubmit}><strong>Search</strong></button>
        </div>
      </div>
    )
  }
